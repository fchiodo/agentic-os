...
export const maintenanceResultSchema = z.object({
  ...
  consolidationProposals: z.number(),
  deferredExpirations: z.number(),
})

export const memoryOperationRecordSchema = z.object({
  id: z.string(),
  kind: z.string(),
  entityId: z.string(),
  stage: z.string(),
  status: z.enum(['active', 'completed', 'rolled_back', 'needs_attention']),
...
export const retrievalBenchmarkReportSchema = z.object({
...
export const documentImportRecordSchema = z.object({
  ...
  warnings: z.array(z.string()),
  extractionEngine: z.string().nullable(),
  extractionVersion: z.string().nullable(),
  extractionQualityScore: z.number().nullable(),
  extractionQualityStatus: z.enum(['passed', 'failed', 'not_applicable']),
  extractionQualityIssues: z.array(z.string()),
...
export const orbitProvenanceSchema = z.object({
  kind: z.string(),
  reference: z.string(),
  detail: z.string(),
